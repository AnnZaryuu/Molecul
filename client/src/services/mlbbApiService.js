    ...
    try {
      ...
      return data.map(item => {
        ...
        return {
          ...
          wins: item.wins !== undefined ? item.wins : null,
          losses: item.losses !== undefined ? item.losses : null,
          gameWins: item.game_wins !== undefined ? item.game_wins : (item.stats?.for || 0),
          winRate: (item.wins !== undefined && item.losses !== undefined && (item.wins + item.losses) > 0) 
